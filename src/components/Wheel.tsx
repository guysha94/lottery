...
import type {PrizeWheelProps, PrizeWheelRef} from "@mertercelik/react-prize-wheel";
import {useWheelAnimation} from "../hooks/useWheelAnimation.ts";
import {generateSectorPaths, generateSticks} from "../generators/sectorGenerator.tsx";

export const Wheel = forwardRef<PrizeWheelRef, PrizeWheelProps>((props, ref) => {
    const {
        sectors,
        onSpinStart,
        onSpinEnd,
